...
let productosJSON = [];
//Acá cargo la variable cantidad para que no se pierdan los datos almacenados al refrescar la ventana
...
$(document).ready(function () {
  ...
  //Acá llamo a las funciones que necesitan renderizarse 
  $("#gastoTotal").html(`Total: $ ${calcularTotalCarrito()}`);
  obtenerJSON();
  renderizarProductos();
  mostrarEnTabla();

  //Este es un evento para que figure una alerta si el carrito esta vacio
...
//Esta es una función para el renderizado de los productos en cards
...
//Acá creo una clase para cargar productos en el carrito y modificar sus cantidades
...
function agregarAlCarrito(productoAgregado) {
  ...
  if (encontrado == undefined) {
    ...
    //Acá le pido al carrito la posicion del producto y despues incremento su cantidad
...
//Esta es una función para rehacer la tabla del modal cada vez que se refresca la pagina y eliminar productos del carrito
